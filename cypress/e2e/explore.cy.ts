...
describe('Explore Page', () => {
  ...
  it('should show 15 games and show more games when show more button is clicked', () => {
  ...
  it('should render empty when no games match', () => {
    cy.visit('/games');
