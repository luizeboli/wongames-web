...
const Logo = ({ color = 'white', size = 'normal', hideTextOnMobile = false, id = 'logo' }: LogoProps) => (
  <S.Container color={color} size={size} hideTextOnMobile={hideTextOnMobile}>
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 158 48" role="img" aria-label="Won Games">
      ...
      />
      <path d="M30.16 27.16l-6.03-4.3a.5.5 0 00-.78.5l1.3 7.3 5.51-3.5z" fill="#110F28" fillOpacity=".15" />
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M13.05 15.1v6M10.04 18.1h6.02" stroke="#0A0D27" strokeWidth="2" strokeLinecap="round" />
      <ellipse rx="1.51" ry="1.5" transform="matrix(1 0 0 1 44.72 13.66)" fill="#0A0D27" />
      <ellipse rx="1.51" ry="1.5" transform="matrix(1 0 0 1 49.74 17.6)" fill="#0A0D27" />
      <ellipse rx="1.51" ry="1.5" transform="matrix(1 0 0 1 44.72 21.6)" fill="#0A0D27" />
      <ellipse rx="1.51" ry="1.5" transform="matrix(1 0 0 1 39.7 17.6)" fill="#0A0D27" />
      <path
        className="text"
      ...
      />
      <defs>
        <linearGradient id={`paint0_linear_${id}`} x1="29.16" y1="-7.4" x2="30.15" y2="49.1" gradientUnits="userSpaceOnUse">
